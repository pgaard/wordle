/**
 * Generates wordle6.json — the pool of possible 6-letter answers.
 *
 * words6.json is a raw scraped list. Two separate problems disqualify much of
 ...
 *
 * The full words6.json remains the *guess* dictionary; removed words are still
...
/* ---------- Build ---------- */
const all = readJson('words6.json').map((w) => w.toLowerCase());
const answers = [];
...
console.log('answers written    : ' + answers.length + '  -> wordle6.json');
